/**
 * Minimal shared UI foundation for studio-mobile — intentionally small
 ...
 * component-library dependency — there is nothing here a real design
 * system wouldn't still need to restyle once an actual brand decision
 * exists.
 */
